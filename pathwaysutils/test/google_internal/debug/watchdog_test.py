...
from pathwaysutils.google_internal.debug import watchdog
...
class WatchdogTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters([
      (
          ...
          1,
          [
              "DEBUG:pathwaysutils.google_internal.debug.watchdog:Thread: 1",
              "DEBUG:pathwaysutils.google_internal.debug.watchdog:examplestack1",
          ],
      ),
      (
          "thread 2",
          2,
          [
              "DEBUG:pathwaysutils.google_internal.debug.watchdog:Thread: 2",
              "DEBUG:pathwaysutils.google_internal.debug.watchdog:examplestack2",
          ],
      ),
      (
          "thread 3",
          3,
          [
              "DEBUG:pathwaysutils.google_internal.debug.watchdog:Thread: 3",
              "DEBUG:pathwaysutils.google_internal.debug.watchdog:",
          ],
      ),
  ])
