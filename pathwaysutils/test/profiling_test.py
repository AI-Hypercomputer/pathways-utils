...
class ProfilingTest(parameterized.TestCase):
  ...
  def test_start_trace_from_request(self, profile_request):
    profiling._start_trace_from_profile_request(profile_request)
  ...
  @parameterized.product(
      create_perfetto_link=[True, False],
      create_perfetto_trace=[True, False],
  )
  def test_start_trace_with_perfetto(
      self, create_perfetto_link, create_perfetto_trace
  ):
    profile_request = {"traceLocation": "gs://test_bucket/test_dir"}
    profiling._start_trace_from_profile_request(
        profile_request,
